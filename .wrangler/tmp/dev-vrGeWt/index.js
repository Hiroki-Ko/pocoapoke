...
// .wrangler/tmp/bundle-KTUKFc/checked-fetch.js
...
async function getPokemonData(env) {
...
__name(getPokemonData, "getPokemonData");
...
async function getMasterCode(env) {
  const { results } = await env.DB.prepare(`
...
__name(getMasterCode, "getMasterCode");
...
// .wrangler/tmp/bundle-KTUKFc/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = functions_default;
...
// .wrangler/tmp/bundle-KTUKFc/middleware-loader.entry.ts
